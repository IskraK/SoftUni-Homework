...
namespace _11.PartyReservationFilterModule2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Func<string, string, bool> startsFilter = (name, letter) => name.StartsWith(letter);
            Func<string, string, bool> endsFilter = (name, letter) => name.EndsWith(letter);
            Func<string, string, bool> containsFilter = (name, letter) => name.Contains(letter);
